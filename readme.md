...
## Bước 1 — Chạy Config Server

Khởi động Config Server trước nếu project sử dụng Config Server.

## Bước 2 — Chạy Discovery Server
...
Kiểm tra các service đã đăng ký thành công.

## Bước 3 — Chạy các Microservice
...
# 9. Chuẩn bị dữ liệu test

## Customer

Tạo ít nhất 2 khách hàng.
...
Có thể tạo thêm một customer không có account để kiểm tra trường hợp lỗi.

---

# 10. Test API

## Test case 1 — Customer hợp lệ và có account ACTIVE
...
# 11. Test case 2 — Customer không tồn tại
...
Loan Service gọi Customer Service:

```http
GET /api/customers/999
```

Nếu Customer Service trả về không tìm thấy customer, Loan Service trả về lỗi và không tạo Loan.

---

# 12. Test case 3 — Customer không có account ACTIVE
...
Customer tồn tại nhưng không có account ACTIVE.
...
# 13. Kiểm tra Gateway Filter

Sau khi gửi request qua:

```text
http://localhost:8222
```

Kiểm tra console của API Gateway.
...
* API Composition.
* Xử lý nghiệp vụ Loan.
* Logging và đo thời gian response.
